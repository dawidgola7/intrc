        ...
        <div className='wrapper_contact'>
            <div className='wrapper_contact--contact'>
                <div className='wrapper_contact--contact-info'>
                    <div className='wrapper_contact--contact-header'>{t('contact_desc_1')}</div>
                    <div className='wrapper_contact--contact-text'>{t('contact_desc_2')}</div>
                ...
                <div className='wrapper_contact--contact-form'>
                    ...
                    <div className="wrapper_contact--contact-form--button">
                        ...
                        <Button style={{ margin:'10px' }} isErrors={isErrors} onClick={handleClick} second>{t('submit')}</Button>
                    </div>
                </div>
            </div>
            <div className='wrapper_contact--footer'>
                <div>Copyright © {new Date().getFullYear()} Ingrifo. All rights reserved.</div>
